...
},{"firebase/compat/app":10,"firebase/compat/database":11}],3:[function(require,module,exports){
"use strict";
...
class FirebaseAppImpl {
  constructor(_delegate, firebase) {
    ...
    (0, modularAPIs._addComponent)(_delegate, new _component.Component('app-compat', () => this, "PUBLIC" /* ComponentType.PUBLIC */));
...
},{"@firebase/app":4,"@firebase/component":5,"@firebase/logger":8,"@firebase/util":9}],4:[function(require,module,exports){
"use strict";
...
},{"@firebase/component":5,"@firebase/logger":8,"@firebase/util":9,"idb":12}],5:[function(require,module,exports){
"use strict";
...
},{"@firebase/util":9}],6:[function(require,module,exports){
"use strict";
...
class Database {
  ...
  constructor(_delegate, app) {
    ...
    this.INTERNAL = {
      ...
      forceWebSockets: _database2.forceWebSockets,
      forceLongPolling: _database2.forceLongPolling
    };
  }
  /**
...
function initStandalone({
  ...
  const container = new _component.ComponentContainer('database-standalone');
  /**
   * ComponentContainer('database-standalone') is just a placeholder that doesn't perform
   * any actual function.
   */
  const authProvider = new _component.Provider('auth-internal', container);
  ...
  if (customAppCheckImpl) {
    appCheckProvider = new _component.Provider('app-check-internal', container);
  ...
  return {
    instance: new Database((0, _database2._repoManagerDatabaseFromApp)(app, authProvider, appCheckProvider, url, nodeAdmin), app),
    namespace
  };
}
...
},{"@firebase/app-compat":3,"@firebase/component":5,"@firebase/database":7,"@firebase/logger":8,"@firebase/util":9}],7:[function(require,module,exports){
 ...
 *
 * @param limit - The maximum number of nodes to include in this query.
 */function limitToLast(limit){if(typeof limit!=='number'||Math.floor(limit)!==limit||limit<=0){throw new Error('limitToLast: First argument must be a positive integer.');}return new QueryLimitToLastConstraint(limit);}class QueryOrderByChildConstraint extends QueryConstraint{constructor(_path){super();this._path=_path;this.type='orderByChild';}_apply(query){validateNoPreviousOrderByCall(query,'orderByChild');const parsedPath=new Path(this._path);if(pathIsEmpty(parsedPath)){throw new Error('orderByChild: cannot pass in empty path. Use orderByValue() instead.');}const index=new PathIndex(parsedPath);const newParams=queryParamsOrderBy(query._queryParams,index);validateQueryEndpoints(newParams);return new QueryImpl(query._repo,query._path,newParams,/*orderByCalled=*/true);}}/**
 ...
 */function orderByPriority(){return new QueryOrderByPriorityConstraint();}class QueryOrderByValueConstraint extends QueryConstraint{constructor(){super(...arguments);this.type='orderByValue';}_apply(query){validateNoPreviousOrderByCall(query,'orderByValue');const newParams=queryParamsOrderBy(query._queryParams,VALUE_INDEX);validateQueryEndpoints(newParams);return new QueryImpl(query._repo,query._path,newParams,/*orderByCalled=*/true);}}/**
 ...
 * @param customAuthImpl - custom auth implementation
 */exports._TEST_ACCESS_forceRestClient=forceRestClient;function _initStandalone({app,url,version,customAuthImpl,customAppCheckImpl,nodeAdmin=false}){setSDKVersion(version);/**
     * ComponentContainer('database-standalone') is just a placeholder that doesn't perform
     * any actual function.
     */const componentContainer=new _component.ComponentContainer('database-standalone');const authProvider=new _component.Provider('auth-internal',componentContainer);let appCheckProvider;if(customAppCheckImpl){appCheckProvider=new _component.Provider('app-check-internal',componentContainer);appCheckProvider.setComponent(new _component.Component('app-check-internal',()=>customAppCheckImpl,"PRIVATE"/* ComponentType.PRIVATE */));}authProvider.setComponent(new _component.Component('auth-internal',()=>customAuthImpl,"PRIVATE"/* ComponentType.PRIVATE */));return repoManagerDatabaseFromApp(app,authProvider,appCheckProvider,url,nodeAdmin);}/**
...
},{"@firebase/app":4,"@firebase/component":5,"@firebase/logger":8,"@firebase/util":9,"_process":1}],8:[function(require,module,exports){
"use strict";
...
},{"@firebase/app-compat":3}],11:[function(require,module,exports){
"use strict";

require("@firebase/database-compat");

},{"@firebase/database-compat":6}],12:[function(require,module,exports){
"use strict";
...
},{"./wrap-idb-value.js":13}],13:[function(require,module,exports){
"use strict";
